...
class StudentTable(Delete, Search):
    ...
    def show_tree_view(self):
        ...
        # Добавьте корневой узел
        root_node = tree.insert("", tk.END, text="Студенты")

        # Добавьте данные в дерево
        for student_row in self.table_data:
            ...
            # Добавьте подузлы с информацией о студенте
    ...
    def load_data_from_xml(self):
        ...
        if filename:
            try:
                ...
                # После успешной загрузки данных из XML обновите данные в таблице
                self.fetch_students_from_db()
    ...
    def save_student_to_xml(self):
        try:
            ...
            filename = tk.filedialog.asksaveasfilename(title="Сохранить данные студента как XML",
    ...
    def change_page_size(self):
        try:
            ...
            if new_page_size <= 0:
                messagebox.showerror("Ошибка", "Число записей на странице должно быть положительным числом.")
                return
    ...
    def fetch_students_from_db(self):
        ...
        try:
            with connection.cursor() as cursor:
                ...
                self.table_data = cursor.fetchall()  # Initialize table_data here
                self.update_main_table()
    ...
    def add_student(self):
        ...
        def add_to_table():
            ...
            for entre in semester_entries:
                semester_value = entre.get()
        ...
        add_button = ttk.Button(student_dialog, text="Добавить", command=add_to_table)
